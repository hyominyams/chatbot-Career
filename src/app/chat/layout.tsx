        ...
        <div className="relative flex h-full flex-col">
          {sidebarOpen ? (
            <button
              ...
              className="absolute right-3 top-1/2 hidden h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-500 shadow-sm transition hover:bg-slate-100 md:flex md:-right-3"
              aria-label="대화 기록 닫기"
            >
      ...
      <div className="relative flex flex-1 flex-col overflow-hidden bg-white">
        {!sidebarOpen ? (
          <button
            ...
            className="absolute left-3 top-1/2 z-40 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-600 shadow transition-colors hover:bg-slate-100 md:left-4"
            aria-label="대화 기록 열기"
          >
            <span className="text-lg">›</span>
          </button>
