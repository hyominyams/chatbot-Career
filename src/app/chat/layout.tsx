      ...
      >
        <div className="relative flex h-full flex-col">
          <button
            ...
            className="absolute right-3 top-3 flex h-8 w-8 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-500 shadow-sm transition hover:bg-slate-100 md:-right-3 md:top-4"
            aria-label="대화 목록 접기"
          >
      ...
      <div className="relative flex flex-1 flex-col overflow-hidden bg-white">
        {!sidebarOpen ? (
          <button
            ...
            className="absolute left-3 top-3 z-40 flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-600 shadow transition hover:bg-slate-100 md:left-4 md:top-4"
            aria-label="대화 목록 열기"
          >
            <span className="text-lg">▶</span>
          </button>
